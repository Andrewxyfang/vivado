...
HD_PWD='D:/vivado/vr_code/simple_cpu/assembly_CPU/assembly_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topone.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topone.tcl
